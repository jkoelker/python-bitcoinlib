...
class RawProxy(object):
    ...
    def __init__(self, service_url=None, service_port=8332, btc_conf_file=None,
                 timeout=HTTP_TIMEOUT, _connection=None):
        ...
        if service_url is None:
            ...
            if btc_conf_file is None:
                if platform.system() == 'Darwin':
                    ...
                    btc_conf_file = os.path.expanduser(path)
...
class Proxy(RawProxy):
    ...
    def getaccountaddress(self, account=None):
        """Return the current Bitcoin address for receiving payments."""
